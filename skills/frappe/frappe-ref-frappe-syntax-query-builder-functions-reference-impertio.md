---
title: Frappe Ref — Frappe Syntax: Query Builder: Functions Reference (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'syntax', 'query', 'builder', 'reference', 'functions-reference']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/syntax/frappe-syntax-query-builder/references/functions-reference.md*
