---
title: Frappe Ref — Frappe Impl: Workspace: Shipping With App (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'workspace', 'reference', 'shipping-with-app']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-workspace/references/shipping-with-app.md*
