---
title: Frappe Ref — Frappe Ops: Frontend Build: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'frontend', 'build', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-frontend-build/references/examples.md*
