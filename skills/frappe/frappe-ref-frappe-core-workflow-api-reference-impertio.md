---
title: Frappe Ref — Frappe Core: Workflow: Api Reference (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'core', 'workflow', 'reference', 'api-reference']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/core/frappe-core-workflow/references/api-reference.md*
