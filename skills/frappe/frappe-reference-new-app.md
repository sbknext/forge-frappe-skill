---
title: Frappe Reference: New App
category: frappe
tags: ['frappe', 'reference', 'netchampfaris', 'app', 'scaffold', 'new']
...
---
*Source: github.com/netchampfaris/frappe-agent-skills/references/new-app.md*
