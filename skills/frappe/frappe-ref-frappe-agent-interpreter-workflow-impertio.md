---
title: Frappe Ref — Frappe Agent: Interpreter: Workflow (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'agent', 'interpreter', 'reference', 'workflow']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/agents/frappe-agent-interpreter/references/workflow.md*
