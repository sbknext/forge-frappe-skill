---
title: Frappe Ref — Frappe Core: Utils: Number Money Functions (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'core', 'utils', 'reference', 'number-money-functions']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/core/frappe-core-utils/references/number-money-functions.md*
