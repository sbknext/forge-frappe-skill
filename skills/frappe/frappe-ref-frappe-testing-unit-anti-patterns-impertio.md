---
title: Frappe Ref — Frappe Testing: Unit: Anti Patterns (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'testing', 'unit', 'reference', 'anti-patterns']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/testing/frappe-testing-unit/references/anti-patterns.md*
