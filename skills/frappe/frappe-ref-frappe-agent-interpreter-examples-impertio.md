---
title: Frappe Ref — Frappe Agent: Interpreter: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'agent', 'interpreter', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/agents/frappe-agent-interpreter/references/examples.md*
