---
title: Frappe Ref — Frappe Syntax: Print: Anti Patterns (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'syntax', 'print', 'reference', 'anti-patterns']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/syntax/frappe-syntax-print/references/anti-patterns.md*
