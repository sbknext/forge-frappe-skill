---
title: Frappe Ref — Frappe Ops: App Lifecycle: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'app', 'lifecycle', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-app-lifecycle/references/examples.md*
