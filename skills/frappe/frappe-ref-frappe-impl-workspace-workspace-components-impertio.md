---
title: Frappe Ref — Frappe Impl: Workspace: Workspace Components (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'workspace', 'reference', 'workspace-components']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-workspace/references/workspace-components.md*
