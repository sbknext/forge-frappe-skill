---
title: Frappe Ref — Frappe Ops: Backup: Workflows (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'backup', 'reference', 'workflows']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-backup/references/workflows.md*
