---
title: Frappe Ref — Frappe Impl: Workflow: Decision Tree (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'workflow', 'reference', 'decision-tree']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-workflow/references/decision-tree.md*
