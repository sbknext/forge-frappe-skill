---
title: Frappe Ref — Frappe Agent: Debugger: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'agent', 'debugger', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/agents/frappe-agent-debugger/references/examples.md*
