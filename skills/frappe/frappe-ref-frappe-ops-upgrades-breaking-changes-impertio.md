---
title: Frappe Ref — Frappe Ops: Upgrades: Breaking Changes (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'upgrades', 'reference', 'breaking-changes']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-upgrades/references/breaking-changes.md*
