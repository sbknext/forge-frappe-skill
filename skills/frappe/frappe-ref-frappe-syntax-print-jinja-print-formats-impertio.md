---
title: Frappe Ref — Frappe Syntax: Print: Jinja Print Formats (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'syntax', 'print', 'reference', 'jinja-print-formats']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/syntax/frappe-syntax-print/references/jinja-print-formats.md*
