---
title: Frappe Ref — Frappe Testing: Unit: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'testing', 'unit', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/testing/frappe-testing-unit/references/examples.md*
