---
title: Frappe Ref — Frappe Ops: Frontend Build: Anti Patterns (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'frontend', 'build', 'reference', 'anti-patterns']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-frontend-build/references/anti-patterns.md*
