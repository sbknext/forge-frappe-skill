---
title: Frappe Ref — Frappe Impl: Controllers: Decision Tree (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'controllers', 'reference', 'decision-tree']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-controllers/references/decision-tree.md*
