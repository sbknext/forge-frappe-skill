---
title: Frappe Ref — Frappe Syntax: Customapp: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'syntax', 'customapp', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/syntax/frappe-syntax-customapp/references/examples.md*
