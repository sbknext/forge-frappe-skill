---
title: Frappe Ref — Frappe Ops: Deployment: Anti Patterns (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'deployment', 'reference', 'anti-patterns']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-deployment/references/anti-patterns.md*
