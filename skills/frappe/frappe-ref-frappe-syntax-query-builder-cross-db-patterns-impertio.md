---
title: Frappe Ref — Frappe Syntax: Query Builder: Cross Db Patterns (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'syntax', 'query', 'builder', 'reference', 'cross-db-patterns']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/syntax/frappe-syntax-query-builder/references/cross-db-patterns.md*
