---
title: Frappe Ref — Frappe Impl: Whitelisted: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'whitelisted', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-whitelisted/references/examples.md*
