---
title: Frappe Ref — Frappe Testing: Unit: Fixtures (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'testing', 'unit', 'reference', 'fixtures']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/testing/frappe-testing-unit/references/fixtures.md*
