---
title: Frappe Ref — Frappe Impl: Workflow: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'workflow', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-workflow/references/examples.md*
