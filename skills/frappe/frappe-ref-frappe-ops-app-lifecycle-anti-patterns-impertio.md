---
title: Frappe Ref — Frappe Ops: App Lifecycle: Anti Patterns (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'app', 'lifecycle', 'reference', 'anti-patterns']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-app-lifecycle/references/anti-patterns.md*
