---
title: Frappe Ref — Frappe Agent: Debugger: Advanced Debugging (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'agent', 'debugger', 'reference', 'advanced-debugging']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/agents/frappe-agent-debugger/references/advanced-debugging.md*
