---
title: Frappe Ref — Frappe Core: Workflow: Anti Patterns (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'core', 'workflow', 'reference', 'anti-patterns']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/core/frappe-core-workflow/references/anti-patterns.md*
