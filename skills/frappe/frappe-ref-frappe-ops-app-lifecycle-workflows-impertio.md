---
title: Frappe Ref — Frappe Ops: App Lifecycle: Workflows (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'app', 'lifecycle', 'reference', 'workflows']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-app-lifecycle/references/workflows.md*
