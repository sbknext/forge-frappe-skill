---
title: Frappe Ref — Frappe Impl: Controllers: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'controllers', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-controllers/references/examples.md*
