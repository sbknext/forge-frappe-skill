---
title: Frappe Ref — Frappe Core: Utils: String Validation Functions (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'core', 'utils', 'reference', 'string-validation-functions']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/core/frappe-core-utils/references/string-validation-functions.md*
