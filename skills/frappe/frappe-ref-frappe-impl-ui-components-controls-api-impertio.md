---
title: Frappe Ref — Frappe Impl: Ui Components: Controls Api (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'ui', 'components', 'reference', 'controls-api']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-ui-components/references/controls-api.md*
