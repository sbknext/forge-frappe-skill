---
title: Frappe Ref — Frappe Core: Workflow: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'core', 'workflow', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/core/frappe-core-workflow/references/examples.md*
