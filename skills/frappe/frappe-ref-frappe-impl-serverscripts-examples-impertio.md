---
title: Frappe Ref — Frappe Impl: Serverscripts: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'serverscripts', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-serverscripts/references/examples.md*
