---
title: Frappe Reference: Existing App
category: frappe
tags: ['frappe', 'reference', 'netchampfaris', 'app', 'setup', 'existing']
...
---
*Source: github.com/netchampfaris/frappe-agent-skills/references/existing-app.md*
