---
title: Frappe Ref — Frappe Syntax: Query Builder: Migration From Sql (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'syntax', 'query', 'builder', 'reference', 'migration-from-sql']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/syntax/frappe-syntax-query-builder/references/migration-from-sql.md*
