---
title: Frappe Ref — Frappe Testing: Cicd: Linting (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'testing', 'cicd', 'reference', 'linting']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/testing/frappe-testing-cicd/references/linting.md*
