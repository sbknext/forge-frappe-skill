---
title: Frappe Ref — Frappe Impl: Hooks: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'hooks', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-hooks/references/examples.md*
