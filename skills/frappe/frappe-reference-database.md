---
title: Frappe Reference: Database
category: frappe
tags: ['frappe', 'reference', 'netchampfaris', 'database', 'orm', 'sql']
...
---
*Source: github.com/netchampfaris/frappe-agent-skills/references/database.md*
