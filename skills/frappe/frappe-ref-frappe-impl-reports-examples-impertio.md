---
title: Frappe Ref — Frappe Impl: Reports: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'reports', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-reports/references/examples.md*
