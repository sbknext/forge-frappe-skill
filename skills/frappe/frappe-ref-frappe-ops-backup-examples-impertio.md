---
title: Frappe Ref — Frappe Ops: Backup: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'backup', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-backup/references/examples.md*
