---
title: Frappe Ref — Frappe Ops: App Lifecycle: Module Workspace Shipping (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'app', 'lifecycle', 'reference', 'module-workspace-shipping']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-app-lifecycle/references/module-workspace-shipping.md*
