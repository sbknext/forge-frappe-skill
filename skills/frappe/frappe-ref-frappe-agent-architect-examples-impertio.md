---
title: Frappe Ref — Frappe Agent: Architect: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'agent', 'architect', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/agents/frappe-agent-architect/references/examples.md*
