---
title: Frappe Ref — Frappe Core: Utils: Date Time Functions (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'core', 'utils', 'reference', 'date-time-functions']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/core/frappe-core-utils/references/date-time-functions.md*
