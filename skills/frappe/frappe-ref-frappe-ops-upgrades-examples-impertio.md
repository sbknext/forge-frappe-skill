---
title: Frappe Ref — Frappe Ops: Upgrades: Examples (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'ops', 'upgrades', 'reference', 'examples']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/ops/frappe-ops-upgrades/references/examples.md*
