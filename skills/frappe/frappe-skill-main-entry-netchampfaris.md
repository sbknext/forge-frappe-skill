---
title: Frappe Skill — Main Entry (netchampfaris)
category: frappe
tags: ['frappe', 'skill', 'agent', 'netchampfaris']
source: netchampfaris
---
...
---
*Source: github.com/netchampfaris/frappe-agent-skills/SKILL.md*
