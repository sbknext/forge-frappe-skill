---
title: Frappe Ref — Frappe Agent: Migrator: Breaking Changes (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'agent', 'migrator', 'reference', 'breaking-changes']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/agents/frappe-agent-migrator/references/breaking-changes.md*
