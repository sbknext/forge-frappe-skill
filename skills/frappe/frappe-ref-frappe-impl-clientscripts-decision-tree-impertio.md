---
title: Frappe Ref — Frappe Impl: Clientscripts: Decision Tree (Impertio)
category: frappe
tags: ['frappe', 'impertio', 'impl', 'clientscripts', 'reference', 'decision-tree']
source: Impertio
---
...
---
*Source: github.com/Impertio-Studio/Frappe_Claude_Skill_Package/skills/source/impl/frappe-impl-clientscripts/references/decision-tree.md*
